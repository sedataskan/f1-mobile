...
class ChampionsItem extends StatefulWidget {
  const ChampionsItem(
      {super.key,
  ...
  @override
  State<ChampionsItem> createState() => _ChampionsItemState();
}

class _ChampionsItemState extends State<ChampionsItem> {
  initState() {
    super.initState();
    getData(
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          NumbersWidget(season: widget.season, points: widget.points),
          const SizedBox(height: 24),
          buildAbout(about),
        ],
      ),
...
class NumbersWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(
        ...
        children: <Widget>[
          buildButton(context, season, 'Year'),
          buildDivider(),
          buildButton(context, "#1", 'Position'),
          buildDivider(),
